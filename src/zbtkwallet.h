...
#ifndef BTK_ZBTKWALLET_H
#define BTK_ZBTKWALLET_H
...
public:
    CzBTKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBTK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBTK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
