...
#ifndef BTK_ZBTKTRACKER_H
#define BTK_ZBTKTRACKER_H
...
public:
    CzBTKTracker(std::string strWalletFile);
    ~CzBTKTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBTKWallet* zBTKWallet = NULL);
