                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BTK Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBTK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BTK Core"), this);
    aboutAction->setStatusTip(tr("Show information about BTK Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BTK Core help message to get a list with possible BTK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BTK Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BTK Core"); // default title
