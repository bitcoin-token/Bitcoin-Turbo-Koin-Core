...
{
    std::string genesisblockhash = "0x0000091228049c6b27072c329ca20b28b2f6cb76bbbc872f1ca1a9cfc8f3a2fa";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            ...
            QMessageBox::warning(this, "BTK Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
