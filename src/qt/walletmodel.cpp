...
static void NotifyzBTKReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzBTKReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzBTKReset.connect(boost::bind(NotifyzBTKReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzBTKReset.disconnect(boost::bind(NotifyzBTKReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zbtkTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus, fWrongSeed);
}
