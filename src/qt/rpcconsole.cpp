                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBTKPathCustom = GetArg("-zbtkbackuppath", "");
    ...
    if(!strzBTKPathCustom.empty()) {
        ui->wallet_customzbtkbackuppath->setText(QString::fromStdString(strzBTKPathCustom));
        ui->wallet_customzbtkbackuppath_label->setVisible(true);
        ui->wallet_customzbtkbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBTKPathCustom.empty()) && nCustomBackupThreshold > 0) {
