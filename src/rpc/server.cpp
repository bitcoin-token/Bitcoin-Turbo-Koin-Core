...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"btk", "mnbudget", &mnbudget, true, true, false},
        {"btk", "preparebudget", &preparebudget, true, true, false},
        {"btk", "submitbudget", &submitbudget, true, true, false},
        {"btk", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"btk", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"btk", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"btk", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"btk", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"btk", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"btk", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"btk", "checkbudgets", &checkbudgets, true, true, false},
        ...
        {"zerocoin", "getzbtkseed", &getzbtkseed, false, false, true},
        {"zerocoin", "setzbtkseed", &setzbtkseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbtk", &searchdzbtk, false, false, true},
        {"zerocoin", "dzbtkstate", &dzbtkstate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:61473/\n";
}
