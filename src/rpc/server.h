...
extern UniValue setzbtkseed(const UniValue& params, bool fHelp);
extern UniValue getzbtkseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbtk(const UniValue& params, bool fHelp);
extern UniValue dzbtkstate(const UniValue& params, bool fHelp);
