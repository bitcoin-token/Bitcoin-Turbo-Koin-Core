...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"zBTKsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBTK denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBTK denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBTK denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBTK denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBTK denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBTK denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBTK denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBTK denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBTK denominations\n"
            "  }\n"
    ...
    UniValue zbtkObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zbtkObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zbtkObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zBTKsupply", zbtkObj));
