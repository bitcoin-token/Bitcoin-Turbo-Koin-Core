...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitcoin Turbo Koin Core btk-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  btk-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded btk transaction") + "\n" +
                               "  btk-tx [options] -create [commands]   " + _("Create hex-encoded btk transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded btk transaction
