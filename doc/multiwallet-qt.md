...
In order to support loading of multiple wallets in btk-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is btk.cpp.
...
Changes to btk.cpp
----------------------
btk.cpp is the entry point into btk-qt, and as such, will require some minor modifications to provide hooks for
