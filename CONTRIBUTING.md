Contributing to BTK Core
============================

The BTK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BTK Core project, and is not to be
confused with overall BTK Network Protocol consensus changes.

Whether a pull request is merged into BTK Core rests with the project merge
...
The project leader is the release manager for each BTK Core release.
