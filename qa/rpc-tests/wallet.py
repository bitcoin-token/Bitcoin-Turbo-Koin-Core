...
#   c) node1 mines 32 blocks, so now node 0 has 60001btk, node 1 has 4250btk, node2 has none.
#   d) node0 sends 601 btk to node2, in two transactions (301 btk, then 300 btk).
